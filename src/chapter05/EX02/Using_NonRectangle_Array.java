...
//		2. 방법2 : 비정방형 배열 선언시 값을 할당.
		...
		arr2[0] = new int[] {1,2};			//0번째 행의 값을 바로 할당.	(주의 : 방 크기를 지정하면 오류)
		arr2[1] = new int[] {3,4,5};		//1번째 행의 값을 바로 할당.
